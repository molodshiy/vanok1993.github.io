  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      css: '\
        ...
        .audiojs .play-pause { width: 25px; height: 40px; padding: 4px 0; margin: 0px; float: left; overflow: hidden; border-right: 1px solid #000; } \
        .audiojs p { display: none; width: 25px; height: 40px; margin: 0px; cursor: pointer; } \
        .audiojs .play { display: block; } \
        .audiojs .scrubber { position: relative; float: left; width: 150px; background: #5a5a5a; height: 14px; margin: 10px 5px; border-top: 1px solid #3f3f3f; border-left: 0px; border-bottom: 0px; overflow: hidden; } \
        ...
        .audiojs .time { float: left; height: 36px; line-height: 36px; padding: 0px 6px; border-left: 1px solid #000; color: #ddd; text-shadow: 1px 1px 0px rgba(0, 0, 0, 0.5); } \
